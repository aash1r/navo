...
export default function GradeSevenToEigthSection(): JSX.Element {
  ...
  const steps: Step[] = [
    ...
    },
    {
      ...
      description: 'In a one-hour session with our counselor, we guide families to:',
      listItems: [
  ...
  return (
    <div id='7to8' className="min-h-screen bg-gray-100 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-800 text-base max-w-3xl mx-auto">
            For families who first connect with us when their children are in grade 7 or 8,
        ...
        <div className="space-y-6">
          {steps.map((step, index) => {
            const isExpanded =
              expandedStep === index || expandedStep === -1; // -1 = expand all
